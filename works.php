...
<head>
    <meta charset="utf-8" />
    <title>Humberto Junior Sousa Oliveira</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Humberto Junior Sousa Oliveira" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Humberto Junior Sousa Oliveira" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.jpg" alt="Humberto Junior Sousa Oliveira">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Humberto Junior Sousa Oliveira</h4>
                        <div class="status">Desenvolvedor WEB</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/humberto-junior-65160a162/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/1bertoh">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                            ...
                            <div class="gallery-grid js-grid-row js-filter-container">
                                ...
                                <figure class="gallery-grid__item category-html category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/pac-food.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Pac-Food</h4>
                                        <span class="gallery-grid__category">https://pacfood-game.firebaseapp.com/ </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/sua-live.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Sua-Live</h4>
                                        <span class="gallery-grid__category">https://sua-live-hoje.firebaseapp.com/ </span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/ibanp.png"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">IBANP</h4>
                                        <span class="gallery-grid__category">https://ibanp-33b71.firebaseapp.com/ </span>
                                    </figcaption>
                                </figure>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Humberto Juniro Sousa Oliveira</footer>
                </div>
            </div>
        </div>
    </main>
