                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="pb-0 pb-sm-2">
                            ...
                            <p>Comecei a estudar programação com começo de 2020, meio perdido por estudar por conta própria,
                                mas com o tempo fui conseguindo traçar minha metas e alcançá-las. Já estudei HTML, CSS, JavaScript, VueJs, Git,
                                 TypeScript, PHP, Laravel além de várias bilbiotecas. Espero continuar evoluindo, aprender e compartilhar meus aprendizados.
                            </p>
                            ...
                            <!-- Footer -->
                            <footer class="footer">
                                © Humberto Junior Sousa Oliveira
                            </footer>
                        </div>
                    </div>
                </div>
